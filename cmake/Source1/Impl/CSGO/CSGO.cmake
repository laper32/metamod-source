...
if (MSVC)
    target_link_options(tier1 PRIVATE /ignore:4006)
else()
...
#
# Make an wrapper for activate the build
#
add_library(sdk_wrapper INTERFACE)
target_include_directories(sdk_wrapper INTERFACE
    ${HL2SDK_PATH}/public
...
target_link_libraries(sdk_wrapper INTERFACE tier0 tier1 vstdlib mathlib interfaces)